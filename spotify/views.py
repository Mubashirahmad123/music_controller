...
class IsAuthenticated(APIView):
    print("hii reached at is authenticated")
    def get(self, request, format=None):
        print("hello")
        is_authenticated = is_spotify_authenticated(self.request.session.session_key)
        
        print("Is user authenticated with Spotify:", is_authenticated)  # Debugging statement
...
class CurrentSong(APIView):
    def get(self, request, format=None):
        ...
        # print(response)
        print(" response from backend worked")
...
#         print("SkipSong post method called")
...
class SkipSong(APIView):
    def post(self, request, format=None):
        print("NextSong post method called")
        room_code = self.request.session.get('room_code')
...
#         # Create a new vote for the current user and the current song, and save it
#         vote = Vote(user=self.request.session.session_key,
#                     room=room, song_id=room.current_song)
#         vote.save()
...
#             # Delete all the votes for the current song and skip the song
#             votes.delete()
#             skip_song(room.host)
